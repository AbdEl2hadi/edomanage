            ...
            {hasError ? (
              <div className="flex items-center justify-center min-h-80 rounded-lg bg-white dark:bg-slate-950 border border-gray-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <div className="flex flex-col items-center justify-center text-center space-y-4 p-12">
                  ...
                  <button
                    onClick={() => refetch()}
                    className="mt-4 px-8 py-3 bg-linear-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200 inline-flex items-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
