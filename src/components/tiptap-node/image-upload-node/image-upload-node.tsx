...
import type { ImageUploadNodeOptions } from '@/components/tiptap-node/image-upload-node/image-upload-node-extension'
...
export const ImageUploadNode: React.FC<NodeViewProps> = (props) => {
  ...
  const extensionOptions = props.extension.options as ImageUploadNodeOptions
  // Use extension options for accept to ensure it's always up-to-date
  const accept = extensionOptions.accept ?? props.node.attrs.accept
