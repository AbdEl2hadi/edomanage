...
import { newInfoAdminSchema } from './settings.schema'
import type { SchoolLogoState } from '@/services/store/school_logo'
import type { NewInfoAdminFields } from './settings.schema'
...
export default function SettingsComp() {
  ...
  } = useForm<NewInfoAdminFields>({
    resolver: zodResolver(newInfoAdminSchema),
    mode: 'onSubmit',
    reValidateMode: 'onChange',
  })

  const onSubmit = async (data: NewInfoAdminFields) => {
    await postNewinfo(data)
  }
  return (
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-700">  
              ...
              <div className="p-4 md:px-6 md:py-5 flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400">
                    Make school events visible across admin, teacher, and
